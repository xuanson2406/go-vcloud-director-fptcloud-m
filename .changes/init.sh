...
echo ""
echo "Changes in progress for v$VERSION are available at [.changes/v$VERSION](https://gitlab.fke.fptcloud.com/xplat-fke/go-vcloud-director-fptcloud/tree/main/.changes/v$VERSION) until the release."
echo ""
