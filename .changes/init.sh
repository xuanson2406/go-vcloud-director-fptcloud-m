...
echo ""
echo "Changes in progress for v$VERSION are available at [.changes/v$VERSION](https://github.com/vmware/go-vcloud-director-fptcloud/tree/main/.changes/v$VERSION) until the release."
echo ""
