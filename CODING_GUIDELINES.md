...
(See [LOGGING.md](https://gitlab.fke.fptcloud.com/xplat-fke/go-vcloud-director-fptcloud/blob/main/util/LOGGING.md)) recording all the requests and responses
...
Every feature in the library must include testing. See [TESTING.md](https://gitlab.fke.fptcloud.com/xplat-fke/go-vcloud-director-fptcloud/blob/main/TESTING.md) for more info.
